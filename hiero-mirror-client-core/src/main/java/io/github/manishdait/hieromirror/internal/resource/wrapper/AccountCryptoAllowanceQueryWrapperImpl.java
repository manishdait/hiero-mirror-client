...
public class AccountCryptoAllowanceQueryWrapperImpl implements AccountCryptoAllowanceQueryWrapper {
  ...
  public AccountCryptoAllowanceQueryWrapperImpl(
  ...
  @Override
  public @NonNull AccountCryptoAllowanceQueryWrapper limit(int limit) {
    this.limit = limit;
    return this;
  }

  @Override
  public @NonNull AccountCryptoAllowanceQueryWrapper order(Order order) {
    this.order = order;
    return this;
  }

  @Override
  public @NonNull AccountCryptoAllowanceQueryWrapper spenderId(CriteriaParam<AccountId> spenderId) {
