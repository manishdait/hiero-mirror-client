...
public class AccountTokenAllowanceQuery
  ...
  MirrorNodeRequest buildRequestInternal(final @NonNull MirrorNodeClient client) {
    MirrorNodeRequest.Builder request =
        MirrorNodeRequest.newBuilder()
            .url(client.getBaseUrl() + "/api/v1/accounts/" + identifier + "/allowances/tokens")
            .method("GET")
  ...
  @Override
  Page<TokenAllowance> mapResponse(@NonNull JsonNode node) {
    return MirrorNodeJsonParser.parseTokenAllowances(node);
  }
}
